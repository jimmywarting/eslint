...
const TokenStore = require('./token-store/index.js')
const astUtils = require('../shared/ast-utils.js')
const Traverser = require('../shared/traverser.js')
...
class SourceCode extends TokenStore {
  ...
  getComments (node) {
    ...
    this.#commentCache.set(node, comments)
    return comments
  }
   ...
   * @public
   * @deprecated (recommend using eslint-plugin-jsdoc)
   */
